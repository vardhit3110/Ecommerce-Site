...
<head>
    ...
    <link rel="stylesheet" href="assets/cancelled_order.css">
</head>
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <h1><i class="fa-solid fa-box"></i> Cancel Order</h1>
        ...
        <div class="container-fluid py-0">
            <div class="card shadow-sm border-1 h-100">
                <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fa-solid fa-list"></i> Cancel Orders</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered border-dark table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT userdata.username, orders.* FROM userdata JOIN orders ON userdata.id = orders.user_id WHERE orders.order_status='5'";
                                $params = [];
                        ...
                        <br>
                        <?php
                        $sql = "SELECT COUNT(*) AS total FROM orders WHERE order_status='5'";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_assoc($result);
                        $total_cancel = $row['total'];
                        $total_page = ceil($total_cancel / $total_data);

                        $start = ($page - 1) * $total_data + 1;
                        $end = min($page * $total_data, $total_cancel);

                        if ($total_cancel > 0) {
                            echo '<div class="d-flex justify-content-between align-items-center flex-wrap mt-3">';

                            echo "<div class='pagination-info mb-0'>Showing $start to $end of $total_cancel entries</div>";
