...
try {
    ...
    if ($payment['status'] === 'captured') {
        ...
        $update_query = "UPDATE orders SET payment_status = '2', payment_id = ?, razorpay_payment_id = ?, order_status = '1' WHERE razorpay_order_id = ? AND user_id = ? AND payment_status = '1'";
        ...
        if ($stmt->affected_rows > 0) {
            ...
            throw new Exception('Failed to update order in database');
        }
    } else {
