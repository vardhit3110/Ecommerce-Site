...
$query = "SELECT c.id, c.user_id, u.username AS name, u.email AS user_email,
          c.subject, c.message, c.reply_status, c.email_send 
          FROM contactus c 
...
<div class="main-content">
    <h1 class="mb-4"><i class="fa-solid fa-envelope"></i> User Contact Messages</h1>

    <div class="card shadow border-0">
        <div class="card-body">
            <h4 class="fw-bold mb-3"><i class="fa-solid fa-message"></i> Contact Messages</h4>
...
<div class="modal fade" id="replyModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="contact-reply-send.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="reply_message" class="form-control" required placeholder="Write your reply..."></textarea>
